...
public class Movie implements Comparable<Movie> {
    ...
    private Person actor; //Поле не может быть null

    public Movie(String name, Coordinates coordinates, long oscarsCount, MovieGenre genre, MpaaRating mpaaRating,
                 Person actor) throws WrongArgumentException {
        checkArguments(name, coordinates, oscarsCount, genre, mpaaRating, actor);
        this.name = name;
    ...
    public Movie(Integer id, String name, Coordinates coordinates, long oscarsCount, MovieGenre genre, MpaaRating mpaaRating,
                 Person actor) throws WrongArgumentException {
        checkArguments(id, name, coordinates, oscarsCount, genre, mpaaRating, actor);
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = ZonedDateTime.now();
    ...
    public void setactor(Person actor) throws WrongArgumentException {
        checkactor(actor);
        this.actor = actor;
    }
